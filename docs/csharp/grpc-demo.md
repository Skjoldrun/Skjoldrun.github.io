...
![greet proto file example](/assets/images/coding/csharp/grpc-demo/greet-proto.png)
...
![service-base-comparison](/assets/images/coding/csharp/grpc-demo/service-class-base-class-comparison.png)
...
![service-base-comparison](/assets/images/coding/csharp/grpc-demo/proto-file-client-settings.png)
...
![service-base-comparison](/assets/images/coding/csharp/grpc-demo/solution-starting-projects-context-menu.png)

Move the server up to be started first and set both to 'start'.

![service-base-comparison](/assets/images/coding/csharp/grpc-demo/solution-starting-projects-settings.png)

![service-base-comparison](/assets/images/coding/csharp/grpc-demo/solution-starting-projects-example.png)
...
![service-base-comparison](/assets/images/coding/csharp/grpc-demo/solution-starting-projects-customers-example.png)
...
![service-base-comparison](/assets/images/coding/csharp/grpc-demo/solution-starting-projects-advanced-example.png)
