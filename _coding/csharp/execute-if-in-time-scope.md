...
It can come in handy to check if the execution time is within a time scope. Use case could be that you would want to only send an alert mail within the working hours.

To achieve this you could use following code:
